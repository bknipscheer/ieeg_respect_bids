...
k = get_mask_V3(cfg(1).sub_labels{:},... % subject name
    ...
    cfg(1).hemisphere,... % 'l' for left 'r' for right --> only use the hemisphere where electrodes are located
...
%% STEP 17: save everything to /Fridge/KNF/chronic_ECoG
