function [out_els,out_els_ind]=electrodes2surf(subject,index,checkdistance,elecselection,elecfname,gsfname,mrfname,outputdir)
% function
...
% returns out_els from p_zoom and generates img and hdr with electrodes on
% surface
...
disp('electrode projected (red=corrected, blue=original), now putting back in image');
